...
import pandas as pd
import time
from genetic_algorithm import calculate_fitness, select_in_tournament, order_crossover, mutate, generate_population
...
for generation in range(num_generations):
    ...
    if stagnation_counter >= stagnation_limit:
        ...
        population = generate_population(population_size - 1, num_nodes)
